...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-full text-sm whitespace-nowrap font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-90",
  {
    variants: {
      variant: {
        default:
