...
export const GridAnimation = ({
  ...
  const text1Opacity: any = useTransform(
    springScroll,
    [0, 0.05, 0.15, 0.2],
    [0, 1, 1, 0]
  );
  const text1Y: any = useTransform(
    springScroll,
    [0, 0.05, 0.15, 0.2],
    ["50%", "0%", "0%", "0%"]
  );

  const text2Opacity: any = useTransform(
    springScroll,
    [0.15, 0.2, 0.3, 0.35],
    [0, 1, 1, 0]
  );
  const text2Y: any = useTransform(
    springScroll,
    [0.15, 0.2, 0.3, 0.35],
    ["50%", "0%", "0%", "0%"]
  );

  const text22Opacity: any = useTransform(
    springScroll,
    [0.3, 0.35, 0.45, 0.5],
    [0, 1, 1, 0]
  );
  const text22Y: any = useTransform(
    springScroll,
    [0.3, 0.35, 0.45, 0.5],
    ["50%", "0%", "0%", "0%"]
  );

  const text3Opacity: any = useTransform(
    springScroll,
    [0.45, 0.5, 0.6, 0.65],
    [0, 1, 1, 0]
  );
  const text3Y: any = useTransform(
    springScroll,
    [0.45, 0.5, 0.6, 0.65],
    ["50%", "0%", "0%", "0%"]
  );

  const text4Opacity: any = useTransform(
    springScroll,
    [0.65, 0.7, 0.8, 0.85],
    [0, 1, 1, 0]
  );
  const text4Y: any = useTransform(
    springScroll,
    [0.65, 0.7, 0.8, 0.85],
    ["50%", "0%", "0%", "50%"]
  );

  const text5Opacity: any = useTransform(
    springScroll,
    [0.8, 0.85, 0.9, 1],
    [0, 1, 1, 1]
  );
  const text5Y: any = useTransform(
    springScroll,
    [0.8, 0.85, 0.9, 1],
    ["50%", "0%", "0%", "0%"]
  );
