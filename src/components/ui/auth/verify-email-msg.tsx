    ...
    <Html>
      ...
      >
        <Body className="bg-transparent my-auto mx-auto font-sans px-2">
          <Container className="border bg-slate-100 dark:bg-slate-900 border-solid border-[#E1A789] rounded-xl my-[40px] mx-auto p-[20px] max-w-[465px]">
            ...
            <Text className="text-slate-800 dark:text-slate-200 text-[24px] font-normal text-center p-0 my-[30px] mx-0">
              <strong>Join Our Charity</strong>
            </Text>
            <Text className="text-slate-800 dark:text-slate-200 text-[14px] leading-[24px]">
            ...
            <Hr className="border border-solid border-slate-300 dark:border-slate-600 my-[26px] mx-0 w-full" />
            <Text className="text-slate-500 dark:text-slate-700 text-[12px] leading-[24px]">
